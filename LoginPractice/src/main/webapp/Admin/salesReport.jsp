    ...
    <%
        if ("post".equalsIgnoreCase(request.getMethod())) {
            ...
            try {
                ...
                String sql = "SELECT SUM(t.total_fare) AS TotalSales, COUNT(t.TicketNumber) AS TotalTicketsSold FROM transaction tr JOIN ticket t ON tr.TicketNumber = t.TicketNumber WHERE MONTH(t.purchaseDateTime) = ? AND YEAR(t.purchaseDateTime) = ?";
